...
export function Toggle(props) {
    ...
    const [opacity, setOpacity] = React.useState(
        getOpacity(isDisabled, disabledOpacity)
    )
...
addPropertyControls(Toggle, {
    ...
    trackBorderColor: {
        ...
        hidden: props =>
            props.designMenu != PropControlMenu.Track || !props.trackBorder,
    },
    trackBorderSize: {
        title: `${LVL2}Size On`,
        type: ControlType.Number,
...
const getOpacity = (isDisabled, disabledOpacity) =>
    isDisabled ? disabledOpacity / 100 : 1
